...
- Raw source dataset in [customer_shopping_behavior.csv](customer_shopping_behavior.csv)
...
Open [customer_shopping_behavior.csv](customer_shopping_behavior.csv) to understand the available fields and sample transactions.
